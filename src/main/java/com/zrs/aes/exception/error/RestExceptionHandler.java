...
import com.zrs.aes.exception.customexceptions.*;
...
//    }
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<ApiError> handleCustomFileNotFoundException(
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<ApiError> handleInvalidKeystorePassException(
            InvalidKeystorePassException ex) {
        logger.info(ex.getClass().getName());
    ...
    public ResponseEntity<ApiError> handleSigningSessionSuspendedException(
            SigningSessionSuspendedException ex) {
        logger.info(ex.getClass().getName());
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<ApiError> handleDocumentAlreadySignedException(
            DocumentAlreadySignedException ex) {
        logger.info(ex.getClass().getName());
    ...
    public ResponseEntity<ApiError> handleGeneralSecurityException(GeneralSecurityException ex) {
        logger.info(ex.getClass().getName());
        String error = "General Security Error";
        ApiError apiError = new ApiError(INTERNAL_SERVER_ERROR, error, ex);
        return new ResponseEntity<>(apiError, apiError.getStatus());
    }

    // TODO MessagingException OperatorCreationException PKCSException GeoIp2Exception
